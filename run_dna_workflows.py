...
def main():
    ...
    if 'host' in workflow_db['options'].keys():
        ...
        dna_workflows.wf_engine.run_wf(workflow_db)
...
def compile_workflow(args):
    ...
    if args.yaml_db:
        ...
        _workflow_db = dna_workflows.schema_tools.load_xl_wf_db(args.db, flatten=True)
    else:
    ...
    if args.offline:
        ...
        api_creds = dna_workflows.load_credentials()
